  ...
  <div id="app">
    ...
    <nav id="nav">
      ...
      <span class="isLogged">
        ...
        <span v-else>
          <a class="a" style="color:white; font-weight: 300; font-size:20px; margin-top:8px;">
             <router-link :to="{ name: 'meal'}">
            <img style="height: 40px; width: auto;" src="./assets/cart.png"/> 
             </router-link>
            <b>{{$root.store.number}} recipes</b>
            </a>
